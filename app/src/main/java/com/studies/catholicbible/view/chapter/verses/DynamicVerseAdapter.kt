...
class DynamicVerseAdapter(var activity: DynamicChaptersActivity,
    ...
    override fun onBindViewHolder(holder: ChapterViewHolder, position: Int) {
        verses[position].let { verse ->
            holder.itemView.let { view ->
                ...
                view.chapter_verse_number_text.setBackgroundColor(colorIdStart)
                view.chapter_verse_description_text.setBackgroundColor(colorIdStart)
    ...
    private fun setViewSelection(view: View, verse: Verse){
        ...
        view.chapter_verse_number_text.setBackgroundColor(colorId)
        view.chapter_verse_description_text.setBackgroundColor(colorId)
