package com.studies.bibleapplication.view.main
...
import com.studies.bibleapplication.view.main.bible.BibleFragment
import com.studies.bibleapplication.view.main.daily.DailyVerseFragment
import com.studies.bibleapplication.view.main.favorites.FavoritesFragment
...
class MainActivity: AppCompatActivity(),
    ...
    override fun onBackPressed() {
        if (supportFragmentManager.fragments.size > 0 && backCount < 1 ) {
            ...
            makeToast(getString(R.string.st_generic_message_click_exit))
        } else {
            super.onBackPressed()
        }
    }
    ...
    private fun searchCurrentFragment(query: String = ""){
        when (val fragment = this.mainAdapter.getItem(main_container_view_pager.currentItem)){
            ...
            else -> makeToast(getString(R.string.st_error_searched))
        }
    }
