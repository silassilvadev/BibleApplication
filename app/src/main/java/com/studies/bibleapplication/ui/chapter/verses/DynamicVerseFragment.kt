package com.studies.bibleapplication.ui.chapter.verses
...
import com.studies.bibleapplication.ui.chapter.DynamicChaptersActivity
import com.studies.bibleapplication.ui.viewmodel.BibleViewModel
...
class DynamicVerseFragment(
    ...
    : Fragment(), IProtocolResponse, ISearchResponse, SwipeRefreshLayout.OnRefreshListener {
    ...
    internal fun initSharing(){
        if (isSharingLimit()) {
            ...
            mainActivity.showToast(getString(R.string.st_error_limit_selected_share))
        }
    }

    internal fun initFavorite(){
        mainActivity.showToast(getString(R.string.st_favorite_title_toolbar))
    }
